...
// MARK: - Widget Data Models (Firebase-free versions)

enum WalkType: Int, Codable, CaseIterable, AppEnum {
    case walk
    case walkAndPoop
...
struct WalkData: Codable {
    ...
    init(id: String, dogID: String, date: Date, walkType: WalkType, ownerName: String) {
        self.id = id
        self.dogID = dogID
        self.date = date
